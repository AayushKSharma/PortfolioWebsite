...
export default function WhiteboardHero() {
  ...
  const onUp = () => { drawing.current = false; last.current = null; prev.current = null }
  ...
  return (
    <section style={{ width: 1180, minWidth: 1180, margin: "0 auto", position: "relative" }}>
      <style>{`
        .wb-link:hover { background: rgba(255,231,122,.5); border-radius: 8px 6px 9px 7px; }
        .wb-reset:hover { color: ${chalk ? "#f1ece0" : "#20242a"}; transform: rotate(-40deg); }
      `}</style>
          ...
          <div style={{
            ...
            <div ref={inkRef} style={{
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16, alignItems: "flex-start" }}>
                <div style={{ fontSize: 84, lineHeight: 1, transform: "rotate(-1.6deg)" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 22, alignItems: "flex-start", pointerEvents: "auto", paddingTop: 12 }}>
                <div style={{ transform: "rotate(-2deg)" }}>
                  <a className="wb-link" href="/blog" style={{ ...navLink, fontSize: 40, lineHeight: 1.15, color: ink(INK.blue) }}>
                    Blog
              ...
              <div style={{ justifySelf: "end", alignSelf: "center", display: "flex", flexDirection: "column", gap: 20, alignItems: "flex-end", pointerEvents: "auto" }}>
                <div style={{ transform: "rotate(1.2deg)" }}>
                  <a className="wb-link" href="/projects" style={{ ...navLink, fontSize: 38, lineHeight: 1.15, color: ink(INK.blue) }}>
                    Projects &amp; Experience
                ...
                <div style={{ fontSize: 22, color: ink(INK.black), transform: "rotate(1.8deg)" }}>ship aotw v2</div>
              </div>

              <div style={{ gridColumn: "1 / -1", justifySelf: "start", fontSize: 24, color: ink(INK.black), transform: "rotate(-3deg)" }}>
