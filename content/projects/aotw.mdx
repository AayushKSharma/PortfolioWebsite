...
githubUrl: ""
liveUrl: "https://www.tamuaotw.com/"
featured: true
---
...
- An __in-house task management spreadsheet__, designed to have minimal overhead while cleanly communicating feature status, expectations, and current buildout and to give a single source of truth about the man hour allocation for any given period of time.
- A __refactor of Git structure__, eliminating vestigial master branch that created unnecessary concurrency debt; this was paired with GitHub CI/CD pipelines using GitHub Actions, both working to ensure readable Git trees.
- A __streamlined onbaording process__, resulting in 24% shorter time-to-productivity gap for new developers.
...
This experience with AotW taught me much when it comes to technical leadership. Answering to someone above you, working alongside other non-technical teams, and aligning a group of busy full-time cs students on an engineering goal were all novel to me. 