...
- A new __interview process__, honed in on collaborative project based development in-person that aimed to capture the ability of candidates to mesh into a team, lead/follow when needed, gather requirements, and thoughtfully use AI tools.
